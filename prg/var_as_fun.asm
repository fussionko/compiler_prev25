.data
_var_fun1: .zero 8
L2: .byte 118, 97, 114, 32, 70, 49, 58, 32, 0
L4: .byte 118, 97, 114, 32, 70, 50, 58, 32, 0
...
_getchar:
  ...
  li a0, 0 # stdin
  mv a1, sp # out buf is actually reg
  sd x0, 0(a1) # zero out buf
  li a2, 1 # num of char read
  ecall
