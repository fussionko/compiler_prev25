...
public class IMC {
	...
	public static class UNOP extends Expr {
		...
		public void log(Logger logger) {
			...
			if (subExpr != null) subExpr.log(logger);
			logger.endElement();
		}

		@Override
		public String toString() {
			if (subExpr == null) return "EROROR" + oper;
	 ...
	 */
	public interface FullVisitor<Result, Arg> extends Visitor<Result, Arg> 
	{
		public default Result visit(BINOP binOp, Arg visArg) 
		{
			if ((binOp.fstExpr != null) || (!compiler.Compiler.devMode()))
				binOp.fstExpr.accept(this, visArg);
			if ((binOp.sndExpr != null) || (!compiler.Compiler.devMode()))
		...
		public default Result visit(CALL call, Arg visArg) 
		{
			for (final Expr expr : call.args)
				if ((expr != null) || (!compiler.Compiler.devMode()))
					expr.accept(this, visArg);
			if ((call.addr != null) || (!compiler.Compiler.devMode()))
				call.addr.accept(this, visArg);
			return null;
		}

		public default Result visit(CJUMP cjump, Arg visArg) 
		{
			if ((cjump.cond != null) || (!compiler.Compiler.devMode()))
				cjump.cond.accept(this, visArg);
			if ((cjump.posAddr != null) || (!compiler.Compiler.devMode()))
				cjump.posAddr.accept(this, visArg);
			if ((cjump.negAddr != null) || (!compiler.Compiler.devMode()))
				cjump.negAddr.accept(this, visArg);
			return null;
		}
		...
		public default Result visit(ESTMT eStmt, Arg visArg) 
		{
			if ((eStmt.expr != null) || (!compiler.Compiler.devMode()))
		...
		public default Result visit(JUMP jump, Arg visArg) 
		{
			if ((jump.addr != null) || (!compiler.Compiler.devMode()))
				jump.addr.accept(this, visArg);
			return null;
		}
		...
		public default Result visit(MEM1 mem, Arg visArg)
		{
			if ((mem.addr != null) || (!compiler.Compiler.devMode()))
		...
		public default Result visit(MOVE move, Arg visArg) 
		{
			if ((move.dst != null) || (!compiler.Compiler.devMode()))
				move.dst.accept(this, visArg);
			if ((move.src != null) || (!compiler.Compiler.devMode()))
		...
		public default Result visit(SEXPR sExpr, Arg visArg) 
		{
			if ((sExpr.stmt != null) || (!compiler.Compiler.devMode()))
				sExpr.stmt.accept(this, visArg);
			if ((sExpr.expr != null) || (!compiler.Compiler.devMode()))
		...
		public default Result visit(STMTS stmts, Arg visArg) 
		{
			for (final Stmt stmt : stmts.stmts)
				if ((stmt != null) || (!compiler.Compiler.devMode()))
		...
		public default Result visit(UNOP unOp, Arg visArg) 
		{
			if ((unOp.subExpr != null) || (!compiler.Compiler.devMode()))
